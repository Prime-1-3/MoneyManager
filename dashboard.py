...
def get_greeting():
    ...
    greetings = {
        6 <= current_hour < 12: "Good Morning",
        12 <= current_hour < 15: "Good Noon",
        15 <= current_hour < 17: "Good Afternoon",
        17 <= current_hour < 20: "Good Evening",
        20 <= current_hour < 24: "Good Night",
        0 <= current_hour < 6: "Good Night"
    }
...
# Time text 
time_text = f'It\'s {get_international_time()}'
...
total_balance_label = Label(frame2, font=("", 14, "bold"), bg='#FF004D')
...
balance_label = Label(frame2, text=balance_text, font=("", 28, "bold"), fg='#9CFF2E', bg='#FF004D')
...
most_income_source_text_label = Label(frame3, text=most_income_source_text, font=("Arial", 22,"bold"), fg='blue', bg='#BFEA7C')
most_income_amount_text_label = Label(frame3, text=most_income_amount_text, font=("Arial", 19,"bold"), fg='red', bg='#BFEA7C')
...
most_expense_label_2 = Label(frame4, text=most_expense_source, font=("Arial", 19,"bold"), fg='yellow', bg='#FF8911')
